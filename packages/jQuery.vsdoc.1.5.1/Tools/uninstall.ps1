...
$projVsDocPath = Join-Path $projectFolder Scripts\jquery-1.5.1-vsdoc.js
$origVsDocPath = Join-Path $installPath Content\Scripts\jquery-1.5.1-vsdoc.js
$origVsDocParaPath = Join-Path $toolsPath jquery-1.5.1-vsdoc-para.js
