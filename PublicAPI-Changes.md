...
Generated: 2025-12-17 14:46:33

## Summary

- **Projects with changes:** 3
- **Total new APIs:** 270
- **Total removed APIs:** 27 **BREAKING CHANGES**
...
### Breaking Changes27 API(s) have been **removed**. These are **BREAKING CHANGES** that will require:
- Major version bump (e.g., 3.x â†’ 4.0)
...
4. After release, run `.\build\Merge-PublicApiFiles.ps1` to move Unshipped â†’ Shipped
