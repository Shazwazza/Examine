...
namespace Examine.LuceneEngine.Scoring
{
    public class FacetLevelScoreQuery : ReaderDataScoreQuery
    {
        ...
        public FacetLevelScoreQuery(Query subQuery, Func<ISearcherContext> contextResolver, ScoreOperation op, params IFacetLevel[] levels)
        ...
        {
            return new ScoreProvider(reader, data, scoreOperation, _levels.Select(l => l.ToFacetLevel(context)).ToArray());
        }
