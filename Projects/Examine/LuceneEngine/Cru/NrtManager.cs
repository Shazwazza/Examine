...
namespace Examine.LuceneEngine.Cru
{
    ...
    /// </summary>
    internal class NrtManager : IDisposable, IEquatable<NrtManager>
    {
        /// <summary>
        /// Used to track this instance Id / equality
        /// </summary>
        ...
        public bool Equals(NrtManager other)
        {
