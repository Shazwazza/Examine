...
//            var filter = criteria.ManagedRangeQuery<DateTime>(new []{ "DateCreated" }, _reIndexDateTime, DateTime.Now, true, true).Compile();

//            var criteriaNotFound = _searcher.CreateSearchCriteria();
//            var filterNotFound = criteriaNotFound.ManagedRangeQuery<DateTime>(new[] { "DateCreated" }, _reIndexDateTime.AddDays(-1), _reIndexDateTime.AddSeconds(-1), true, true).Compile();
...
//        //    var filter = criteria.ManagedRangeQuery<DateTime>("YearCreated", _reIndexDateTime, DateTime.Now, true, true, SearchCriteria.DateResolution.Year).Compile();

//        //    var criteriaNotFound = _searcher.CreateSearchCriteria();
//        //    var filterNotFound = criteriaNotFound.ManagedRangeQuery<DateTime>("YearCreated", DateTime.Now.AddYears(-2), DateTime.Now.AddYears(-1), true, true).Compile();
...
//            var criteria = _searcher.CreateSearchCriteria();
//            var filter = criteria.ManagedRangeQuery<int>(new []{ "SomeNumber" }, 0, 100, true, true).Compile();

//            var criteriaNotFound = _searcher.CreateSearchCriteria();
//            var filterNotFound = criteriaNotFound.ManagedRangeQuery<int>(new[] { "SomeNumber" }, 101, 200, true, true).Compile();
...
//            //all numbers should be between 0 and 100 based on the data source
//            var criteria = _searcher.CreateSearchCriteria();
//            var filter = criteria.ManagedRangeQuery<float>(new []{ "SomeFloat" }, 0f, 100f, true, true).Compile();

//            var criteriaNotFound = _searcher.CreateSearchCriteria();
//            var filterNotFound = criteriaNotFound.ManagedRangeQuery<float>(new[] { "SomeFloat" }, 101f, 200f, true, true).Compile();
...
//            //all numbers should be between 0 and 100 based on the data source
//            var criteria = _searcher.CreateSearchCriteria();
//            var filter = criteria.ManagedRangeQuery<double>(new []{ "SomeDouble" }, 0d, 100d, true, true).Compile();

//            var criteriaNotFound = _searcher.CreateSearchCriteria();
//            var filterNotFound = criteriaNotFound.ManagedRangeQuery<double>(new[] { "SomeDouble" }, 101d, 200d, true, true).Compile();
...
//            //all numbers should be between 0 and 100 based on the data source
//            var criteria = _searcher.CreateSearchCriteria();
//            var filter = criteria.ManagedRangeQuery<long>(new []{ "SomeLong" }, 0L, 100L, true, true).Compile();

//            var criteriaNotFound = _searcher.CreateSearchCriteria();
//            var filterNotFound = criteriaNotFound.ManagedRangeQuery<long>(new[] { "SomeLong" }, 101L, 200L, true, true).Compile();
