...
namespace Examine.Lucene.Search
{
    ...
    public class LuceneSearchQuery : LuceneSearchQueryBase, IQueryExecutor
    {
        ...
        public override IFacetQueryField Facet(string field, params string[] values) => FacetInternal(field, values);

        public override IFacetDoubleRangeQueryField Facet(string field, params DoubleRange[] doubleRanges) => FacetInternal(field, doubleRanges);

        public override IFacetLongRangeQueryField Facet(string field, params Int64Range[] longRanges) => FacetInternal(field, longRanges);
