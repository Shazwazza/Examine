...
namespace Examine.Lucene.Search
{
    ...
    public readonly struct FacetLongField : IFacetField
    {
        ...
        public IEnumerable<KeyValuePair<string, IFacetResult>> ExtractFacets(IFacetExtractionContext facetExtractionContext)
        {
            ...
            yield return new KeyValuePair<string, IFacetResult>(Field, new FacetResult(longFacets.LabelValues.Select(labelValue => new FacetValue(labelValue.Label, labelValue.Value) as IFacetValue)));
        }
    }
}
