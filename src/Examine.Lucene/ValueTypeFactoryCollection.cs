    ...
    public class ValueTypeFactoryCollection : IEnumerable<KeyValuePair<string, IFieldValueTypeFactory>>
    {
        ...
        private static IReadOnlyDictionary<string, Func<string, IIndexFieldValueType>> GetDefaults(ILoggerFactory loggerFactory, Analyzer defaultAnalyzer = null) =>
            new Dictionary<string, Func<string, IIndexFieldValueType>>(StringComparer.InvariantCultureIgnoreCase) //case insensitive
            {
                ...
                {FieldDefinitionTypes.FacetInteger, name => new Int32Type(name, loggerFactory, isFacetable: true)},
                {FieldDefinitionTypes.FacetFloat, name => new SingleType(name, loggerFactory, isFacetable: true)},
                {FieldDefinitionTypes.FacetDouble, name => new DoubleType(name, loggerFactory, isFacetable: true)},
                {FieldDefinitionTypes.FacetLong, name => new Int64Type(name, loggerFactory, isFacetable: true)},
                {FieldDefinitionTypes.FacetDateTime, name => new DateTimeType(name, loggerFactory, DateResolution.MILLISECOND, isFacetable: true)},
                {FieldDefinitionTypes.FacetDateYear, name => new DateTimeType(name, loggerFactory, DateResolution.YEAR, isFacetable: true)},
                {FieldDefinitionTypes.FacetDateMonth, name => new DateTimeType(name, loggerFactory, DateResolution.MONTH, isFacetable: true)},
                {FieldDefinitionTypes.FacetDateDay, name => new DateTimeType(name, loggerFactory, DateResolution.DAY, isFacetable: true)},
                {FieldDefinitionTypes.FacetDateHour, name => new DateTimeType(name, loggerFactory, DateResolution.HOUR, isFacetable: true)},
                {FieldDefinitionTypes.FacetDateMinute, name => new DateTimeType(name, loggerFactory, DateResolution.MINUTE, isFacetable: true)},
                {FieldDefinitionTypes.FacetFullText, name => new FullTextType(name, loggerFactory, defaultAnalyzer, isFacetable: true)},
                {FieldDefinitionTypes.FacetFullTextSortable, name => new FullTextType(name, loggerFactory, defaultAnalyzer, true, isFacetable: true)},
                {FieldDefinitionTypes.FacetTaxonomyInteger, name => new Int32Type(name, loggerFactory, isFacetable: true, taxonomyIndex: true)},
                {FieldDefinitionTypes.FacetTaxonomyFloat, name => new SingleType(name, loggerFactory, isFacetable: true, taxonomyIndex: true)},
                {FieldDefinitionTypes.FacetTaxonomyDouble, name => new DoubleType(name, loggerFactory, isFacetable: true, taxonomyIndex: true)},
                {FieldDefinitionTypes.FacetTaxonomyLong, name => new Int64Type(name, loggerFactory, isFacetable: true, taxonomyIndex: true)},
                {FieldDefinitionTypes.FacetTaxonomyDateTime, name => new DateTimeType(name, loggerFactory, DateResolution.MILLISECOND, isFacetable: true, taxonomyIndex: true)},
                {FieldDefinitionTypes.FacetTaxonomyDateYear, name =>  new DateTimeType(name, loggerFactory, DateResolution.YEAR, isFacetable: true, taxonomyIndex: true)},
                {FieldDefinitionTypes.FacetTaxonomyDateMonth, name =>new DateTimeType(name, loggerFactory, DateResolution.MONTH, isFacetable: true, taxonomyIndex: true)},
                {FieldDefinitionTypes.FacetTaxonomyDateDay, name =>new DateTimeType(name, loggerFactory, DateResolution.DAY, isFacetable: true, taxonomyIndex: true)},
                {FieldDefinitionTypes.FacetTaxonomyDateHour, name => new DateTimeType(name, loggerFactory, DateResolution.HOUR, isFacetable: true, taxonomyIndex: true)},
                {FieldDefinitionTypes.FacetTaxonomyDateMinute, name => new DateTimeType(name, loggerFactory, DateResolution.MINUTE, isFacetable: true, taxonomyIndex: true)},
                {FieldDefinitionTypes.FacetTaxonomyFullText, name => new FullTextType(name, loggerFactory, defaultAnalyzer, isFacetable: true, taxonomyIndex: true)},
                {FieldDefinitionTypes.FacetTaxonomyFullTextSortable, name => new FullTextType(name, loggerFactory, defaultAnalyzer, isFacetable: true, taxonomyIndex: true)},
                };
