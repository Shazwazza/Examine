    ...
    public class ValueTypeFactoryCollection : IEnumerable<KeyValuePair<string, IFieldValueTypeFactory>>
    {
        ...
        private static IReadOnlyDictionary<string, Func<string, IIndexFieldValueType>> GetDefaults(ILoggerFactory loggerFactory, Analyzer defaultAnalyzer = null) =>
            new Dictionary<string, Func<string, IIndexFieldValueType>>(StringComparer.InvariantCultureIgnoreCase) //case insensitive
            {
                ...
                {FieldDefinitionTypes.FullTextSuggestable, name => new FullTextType(name,
                                                                                    loggerFactory,
                                                                                    defaultAnalyzer,
                                                                                    false,
                                                                                    true,
                ...
                {FieldDefinitionTypes.FullTextSortableSuggestable, name => new FullTextType(name,
                                                                                            loggerFactory,
                                                                                            defaultAnalyzer,
                                                                                            true,
                                                                                            true,
                                                                                            (readerReference, suggestionOptions, searchText) => FullTextType.ExecuteAnalyzingSuggester(readerReference, suggestionOptions, searchText, name, defaultAnalyzer))},
                {FieldDefinitionTypes.FullTextFuzzySuggestable, name => new FullTextType(name,
                                                                                         loggerFactory,
                                                                                         defaultAnalyzer,
                                                                                         false,
                                                                                         true,
                ...
                {FieldDefinitionTypes.FullTextSortableFuzzySuggestable, name => new FullTextType(name,
                                                                                                 loggerFactory,
                                                                                                 defaultAnalyzer,
                                                                                                 true,
                                                                                                 true,
                                                                                                 (readerReference, suggestionOptions, searchText) => FullTextType.ExecuteFuzzySuggester(readerReference, suggestionOptions, searchText, name, defaultAnalyzer))},
                {FieldDefinitionTypes.FullTextSpelling, name => new FullTextType(name,
                                                                                 loggerFactory,
                                                                                 defaultAnalyzer,
                                                                                 false,
                                                                                 true,
                ...
                {FieldDefinitionTypes.FullTextSortableSpelling, name => new FullTextType(name,
                                                                                         loggerFactory,
                                                                                         defaultAnalyzer,
                                                                                         true,
                                                                                         true,
